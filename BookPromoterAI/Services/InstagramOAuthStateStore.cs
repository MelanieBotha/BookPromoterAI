...
sealed class InstagramOAuthPending
{
...
static class InstagramOAuthStateStore
{
    const string Prefix = "instagram_oauth:";
    ...
    public static async Task SaveAsync(
        IDistributedCache cache, string state, InstagramOAuthPending pending, CancellationToken cancellationToken = default)
    {
    ...
    public static async Task<InstagramOAuthPending?> TakeAsync(
        IDistributedCache cache, string state, CancellationToken cancellationToken = default)
    {
        ...
        return JsonSerializer.Deserialize<InstagramOAuthPending>(json, JsonOptions);
    }
