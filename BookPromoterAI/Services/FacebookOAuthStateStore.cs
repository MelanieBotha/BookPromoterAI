...
sealed class FacebookOAuthPending
{
...
{
    const string Prefix = "facebook_oauth:";
    ...
    public static async Task SaveAsync(
        IDistributedCache cache, string state, FacebookOAuthPending pending, CancellationToken cancellationToken = default)
    {
    ...
    public static async Task<FacebookOAuthPending?> TakeAsync(
        IDistributedCache cache, string state, CancellationToken cancellationToken = default)
    {
        ...
        return JsonSerializer.Deserialize<FacebookOAuthPending>(json, JsonOptions);
    }
