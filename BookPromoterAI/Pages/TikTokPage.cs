    ...
    public static string Render(AppStoreDb store, PostGenerator generator, string notice = "")
    {
        ...
        var connectBanner = !store.IsTikTokConfigured
            ...
            : tiktokAccount is not null
                ...
                : $"""
                    <div class="notice">
                        Connect TikTok to send videos to your inbox from this page (or keep downloading and posting yourself).
                        <a class="button small" style="background:#000;margin-left:0.5rem" href="/social-accounts/connect/TikTok?return={Uri.EscapeDataString(SocialConnectHelper.VideosReturnPath)}">Connect TikTok</a>
                    </div>
                    """;
        ...
        return $"""
            ...
            <section class="panel">
                ...
                <p class="muted small-text">{H.Encode(currentWeekLabel)} — one 60-second video per book from your description and cover (read-aloud voice when available, otherwise animated captions). Refreshes every Monday. If you removed videos, use Generate / Regenerate below.</p>
                {weekActions}
