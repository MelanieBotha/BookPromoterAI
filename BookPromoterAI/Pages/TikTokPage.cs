    ...
    static string RenderVideoRow(TikTokVideo video)
    {
        ...
        var preview = video.Status == TikTokVideoStatuses.Ready && !string.IsNullOrWhiteSpace(video.VideoUrl)
            ? $"""
                ...
                <a class="button small tiktok-download-btn" href="{H.Encode(video.VideoUrl)}" download="{H.Encode(video.BookTitle)}-promo.webm">Download video</a>
                """
        ...
        var download = video.Status == TikTokVideoStatuses.Ready && !string.IsNullOrWhiteSpace(video.VideoUrl)
            ? $"""<a class="button small" href="{H.Encode(video.VideoUrl)}" download="{H.Encode(video.BookTitle)}-promo.webm">Download</a>"""
            : "";
