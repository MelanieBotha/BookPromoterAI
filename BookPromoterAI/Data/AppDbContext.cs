...
class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder model)
    {
        ...
        model.Entity<DbSubscriptionPlan>().HasData(
            new DbSubscriptionPlan { Id = "starter",      Name = "Starter",      MonthlyFee = 9.99m,  BookLimit = 5,  SocialAccountLimit = 2,  AiPostsPerMonth = 50,  HasTeamAccess = false, HasAdvancedAnalytics = false, HasMultiClient = false, FeaturesJson = """["5 books","2 social accounts","50 AI posts/month"]""" },
